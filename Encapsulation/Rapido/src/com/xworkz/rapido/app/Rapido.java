...
public class Rapido {
	 private String passengerName;
	    ...
	    private boolean isCaptainRated;
	    ...
	    public boolean isCaptainRated() {
	        return isCaptainRated;
	    }

	    public void setCaptainRated(boolean captainRated) {
	        isCaptainRated = captainRated;
	    }
